...
user_store_selection = int(input("Please select 1 or 2 from the list of stores above: "))
...
if user_store_selection == 1:
    nike()
if user_store_selection == 2:
    cottonon()
